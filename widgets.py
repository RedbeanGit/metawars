...
class Bouton(Widget):
	...
	def __init__(self, affichage, action, texte="", arguments_action=(), position=(0, 0), taille=(1, 1), ancrage=(-1, -1), taille_police=20):
		...
		# on stock les arguments à passer à l'action dans un attribut
